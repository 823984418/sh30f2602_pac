#[doc = "Register `OPR` reader"]
pub type R = crate::R<OprSpec>;
...
#[doc = "OPR\n\nYou can [`read`](crate::Reg::read) this register and get [`opr::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct OprSpec;
impl crate::RegisterSpec for OprSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`opr::R`](R) reader structure"]
impl crate::Readable for OprSpec {}
#[doc = "`reset()` method sets OPR to value 0"]
impl crate::Resettable for OprSpec {}
