#[doc = "Register `OPR_DESI0` reader"]
pub type R = crate::R<OprDesi0Spec>;
...
#[doc = "OPR_DESI0\n\nYou can [`read`](crate::Reg::read) this register and get [`opr_desi0::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct OprDesi0Spec;
impl crate::RegisterSpec for OprDesi0Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`opr_desi0::R`](R) reader structure"]
impl crate::Readable for OprDesi0Spec {}
#[doc = "`reset()` method sets OPR_DESI0 to value 0"]
impl crate::Resettable for OprDesi0Spec {}
