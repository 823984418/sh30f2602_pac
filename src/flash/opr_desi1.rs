#[doc = "Register `OPR_DESI1` reader"]
pub type R = crate::R<OprDesi1Spec>;
...
#[doc = "OPR_DESI1\n\nYou can [`read`](crate::Reg::read) this register and get [`opr_desi1::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct OprDesi1Spec;
impl crate::RegisterSpec for OprDesi1Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`opr_desi1::R`](R) reader structure"]
impl crate::Readable for OprDesi1Spec {}
#[doc = "`reset()` method sets OPR_DESI1 to value 0"]
impl crate::Resettable for OprDesi1Spec {}
