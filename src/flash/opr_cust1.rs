#[doc = "Register `OPR_CUST1` reader"]
pub type R = crate::R<OprCust1Spec>;
...
#[doc = "`read()` method returns [`opr_cust1::R`](R) reader structure"]
impl crate::Readable for OprCust1Spec {}
#[doc = "`reset()` method sets OPR_CUST1 to value 0"]
impl crate::Resettable for OprCust1Spec {}
