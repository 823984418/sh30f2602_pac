#[doc = "Register `OPR_DESI2` reader"]
pub type R = crate::R<OprDesi2Spec>;
...
#[doc = "OPR_DESI2\n\nYou can [`read`](crate::Reg::read) this register and get [`opr_desi2::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct OprDesi2Spec;
impl crate::RegisterSpec for OprDesi2Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`opr_desi2::R`](R) reader structure"]
impl crate::Readable for OprDesi2Spec {}
#[doc = "`reset()` method sets OPR_DESI2 to value 0"]
impl crate::Resettable for OprDesi2Spec {}
