#[doc = "Register `CCMR0` reader"]
pub type R = crate::R<Ccmr0Spec>;
#[doc = "Register `CCMR0` writer"]
pub type W = crate::W<Ccmr0Spec>;
...
impl W {
    #[doc = "Bit 0"]
    #[inline(always)]
    pub fn ccie(&mut self) -> CcieW<'_, Ccmr0Spec> {
        CcieW::new(self, 0)
    }
    #[doc = "Bit 1"]
    #[inline(always)]
    pub fn rev1(&mut self) -> Rev1W<'_, Ccmr0Spec> {
        Rev1W::new(self, 1)
    }
    #[doc = "Bit 2"]
    #[inline(always)]
    pub fn tcp(&mut self) -> TcpW<'_, Ccmr0Spec> {
        TcpW::new(self, 2)
    }
    #[doc = "Bit 3"]
    #[inline(always)]
    pub fn cen(&mut self) -> CenW<'_, Ccmr0Spec> {
        CenW::new(self, 3)
    }
    #[doc = "Bits 4:5"]
    #[inline(always)]
    pub fn fs(&mut self) -> FsW<'_, Ccmr0Spec> {
        FsW::new(self, 4)
    }
    #[doc = "Bits 6:7"]
    #[inline(always)]
    pub fn sm(&mut self) -> SmW<'_, Ccmr0Spec> {
        SmW::new(self, 6)
    }
    #[doc = "Bit 8"]
    #[inline(always)]
    pub fn cc(&mut self) -> CcW<'_, Ccmr0Spec> {
        CcW::new(self, 8)
    }
    #[doc = "Bits 9:11"]
    #[inline(always)]
    pub fn icf(&mut self) -> IcfW<'_, Ccmr0Spec> {
        IcfW::new(self, 9)
    }
    #[doc = "Bit 12"]
    #[inline(always)]
    pub fn cssel(&mut self) -> CsselW<'_, Ccmr0Spec> {
        CsselW::new(self, 12)
    }
    #[doc = "Bits 13:31"]
    #[inline(always)]
    pub fn rev0(&mut self) -> Rev0W<'_, Ccmr0Spec> {
        Rev0W::new(self, 13)
    }
}
#[doc = "CCMR0\n\nYou can [`read`](crate::Reg::read) this register and get [`ccmr0::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`ccmr0::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Ccmr0Spec;
impl crate::RegisterSpec for Ccmr0Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`ccmr0::R`](R) reader structure"]
impl crate::Readable for Ccmr0Spec {}
#[doc = "`write(|w| ..)` method takes [`ccmr0::W`](W) writer structure"]
impl crate::Writable for Ccmr0Spec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets CCMR0 to value 0"]
impl crate::Resettable for Ccmr0Spec {}
