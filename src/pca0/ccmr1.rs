...
impl W {
    #[doc = "Bit 0"]
    #[inline(always)]
    pub fn ccie(&mut self) -> CcieW<'_, Ccmr1Spec> {
        CcieW::new(self, 0)
    }
    #[doc = "Bit 1"]
    #[inline(always)]
    pub fn rev1(&mut self) -> Rev1W<'_, Ccmr1Spec> {
        Rev1W::new(self, 1)
    }
    #[doc = "Bit 2"]
    #[inline(always)]
    pub fn tcp(&mut self) -> TcpW<'_, Ccmr1Spec> {
        TcpW::new(self, 2)
    }
    #[doc = "Bit 3"]
    #[inline(always)]
    pub fn cen(&mut self) -> CenW<'_, Ccmr1Spec> {
        CenW::new(self, 3)
    }
    #[doc = "Bits 4:5"]
    #[inline(always)]
    pub fn fs(&mut self) -> FsW<'_, Ccmr1Spec> {
        FsW::new(self, 4)
    }
    #[doc = "Bits 6:7"]
    #[inline(always)]
    pub fn sm(&mut self) -> SmW<'_, Ccmr1Spec> {
        SmW::new(self, 6)
    }
    #[doc = "Bit 8"]
    #[inline(always)]
    pub fn cc(&mut self) -> CcW<'_, Ccmr1Spec> {
        CcW::new(self, 8)
    }
    #[doc = "Bits 9:11"]
    #[inline(always)]
    pub fn icf(&mut self) -> IcfW<'_, Ccmr1Spec> {
        IcfW::new(self, 9)
    }
    #[doc = "Bit 12"]
    #[inline(always)]
    pub fn cssel(&mut self) -> CsselW<'_, Ccmr1Spec> {
        CsselW::new(self, 12)
    }
    #[doc = "Bits 13:31"]
    #[inline(always)]
    pub fn rev0(&mut self) -> Rev0W<'_, Ccmr1Spec> {
        Rev0W::new(self, 13)
    }
}
